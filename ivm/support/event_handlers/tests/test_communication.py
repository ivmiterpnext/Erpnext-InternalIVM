...
from ivm.support.event_handlers.communication import on_update, SUPPORT_ISSUE_TYPES
...
class TestCommunicationOnUpdate(FrappeTestCase):
    ...
    def test_attachment_creates_file_on_issue(self):
        ...
        issue_file = frappe.db.exists('File', {
    ...
    def test_attachment_deduplication(self):
        ...
        # Count files before
        count_before = frappe.db.count('File', {
            'file_url': file_doc.file_url,
            'attached_to_doctype': 'Issue',
            'attached_to_name': issue.name
        })
        ...
        count_after = frappe.db.count('File', {
            'file_url': file_doc.file_url,
            'attached_to_doctype': 'Issue',
            'attached_to_name': issue.name
        })
    ...
    def test_exception_logged_not_raised(self):
        ...
        with patch('ivm.support.event_handlers.communication.frappe.get_doc', side_effect=side_effect_get_doc):
