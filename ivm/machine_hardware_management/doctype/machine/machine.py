...
def _resolve_customer_name(icorp_client_name):
	...
	customer = frappe.db.get_value("Customer", {"icorp_client_id": icorp_client_name}, "name")
...
class Machine(BaseVirtualDoctype):
	...
	BOOL_FIELDS: ClassVar[list[str]] = [
		"has_smart_screen",
		"use_machine_timezone",
		"using_job_code",
		"allow_skip_job_code",
		"is_vend_return",
	]
	FIELD_MAP: ClassVar[dict[str, str]] = {"name": "id", "machine_name": "name"}
	endpoint = "SV/Machine"
