...
frappe.ui.form.on('Board', {
    onload: function(frm) {
        ...
        frm.set_query('board_manufacturer_id', function() {
            return { query: 'ivm.machine_hardware_management.services.link_queries.get_board_manufacturer_link' };
        });

        frm.set_query('board_type_code', function() {
            return { query: 'ivm.machine_hardware_management.services.link_queries.get_board_type_link' };
        });

        frm.set_query('hardware_availability_type_code', function() {
            return { query: 'ivm.machine_hardware_management.services.link_queries.get_hardware_availability_type_link' };
        });
