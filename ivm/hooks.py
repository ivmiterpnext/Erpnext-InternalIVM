...
scheduler_events = {
    "daily": [
        "ivm.mssql_frappe.mssql_frappe.doctype.address_link.address_link.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.agreement_fee_type.agreement_fee_type.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.board_link.board_link.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.board_connection.board_connection.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.board_firmware.board_firmware.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.board_manufacturer.board_manufacturer.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.board_type.board_type.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.client_link.client_link.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.hardware_availability_type.hardware_availability_type.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.hardware_connectivity_type.hardware_connectivity_type.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.location_link.location_link.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.machine_activity_log_type.machine_activity_log_type.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.machine_authorization_type.machine_authorization_type.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.machine_contract_length_type.machine_contract_length_type.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.machine_link.machine_link.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.machine_purpose.machine_purpose.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.machine_status_type.machine_status_type.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.machine_type.machine_type.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.push_message_type.push_message_type.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.smart_screen_configuration.smart_screen_configuration.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.smart_screen_group.smart_screen_group.sync",
        "ivm.mssql_frappe.mssql_frappe.doctype.vendor_link.vendor_link.sync"
    ],
}
