...
class TestUpdateDueDates(ERPNextTestSuite):
    ...
    def test_domestic_not_expedited_uses_domestic_days(self):
        ...
        self.assertEqual(getdate(doc.approve_planogram_and_locker_config_due), getdate(expected_approve_planogram))
        ...
        self.assertEqual(getdate(doc.delivery_and_install_contact_due_customs), getdate(expected_delivery_contact))
        ...
        self.assertEqual(getdate(doc.user_and_restriction_requirements_due), getdate(expected_user_restriction))
...
class TestLinkCrmDeal(ERPNextTestSuite):
    ...
    def test_already_linked_deal_not_overwritten(self):
        ...
        deal2 = _make_deal(custom_hubspot_deal_id="hubspot_deal_2")
...
class TestAfterInsert(ERPNextTestSuite):
    ...
    def test_after_insert_calls_create_machines(self):
        ...
        with patch("ivm.deployments.services.create_machines_from_project.create_machines_from_project") as mock_create:
