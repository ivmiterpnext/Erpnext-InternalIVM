...
frappe.ui.form.on('Board', {
    onload: function(frm) {
        ...
        frappe.call({
            method: "mssql_frappe.mssql_frappe.doctype.board.board.get_rfid_target_number_base_types",
            callback: function(r) {
                if (r.message) {
    ...
    serial_number: function(frm) {
        if (frm.doc.serial_number) {
            frappe.call({
                method: "mssql_frappe.mssql_frappe.doctype.board.board.get_manufacturer_by_serial_number",
