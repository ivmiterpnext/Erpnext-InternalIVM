/**
 * Shared smart detail grid setup and bins editor.
 *
...
/**
 * Disable inline grid editing and add CSS class for smart detail tables.
 * @param {object} frm - The form object
 * @param {string[]} tableFieldnames - The child table fieldnames to set up
 */
function setupSmartDetailGrids(frm, tableFieldnames) {
...
/**
 * Validate that machine_name is unique within each smart detail child table.
...
Object.assign(window, { setupSmartDetailGrids, injectBinsEditor, validateUniqueMachineNames });
