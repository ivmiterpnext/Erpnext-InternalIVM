...
MACHINE_TYPE_TO_CHILD_DOCTYPE: dict[str, str] = {
	hs_type: TABLE_TO_DOCTYPE[table_field] for hs_type, table_field in MACHINE_TYPE_TO_CHILD_TABLE.items()
}
...
MACHINE_PROPERTIES: dict[str, list[str]] = {
	type_id: list(field_map.keys()) for type_id, field_map in MACHINE_FIELD_MAPS.items()
}
