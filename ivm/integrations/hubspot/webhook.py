...
_OBJECT_TYPE_HANDLERS: dict[str, dict[str, tuple[str, Any]]] = {
	...
	CONTACT_TYPE_ID: {
		...
		"object.propertyChange": (
			f"{_HANDLER_PREFIX}.contact_handler.handle_contact_updated",
			_contact_kwargs,
		),
	...
	COMPANY_TYPE_ID: {
		...
		"object.propertyChange": (
			f"{_HANDLER_PREFIX}.company_handler.handle_company_updated",
			_company_kwargs,
		),
		"object.associationChange": (
			f"{_HANDLER_PREFIX}.company_handler.handle_company_updated",
	...
	DEPLOYMENT_SITE_TYPE_ID: {
		...
		"object.propertyChange": (
			f"{_HANDLER_PREFIX}.deployment_site_handler.handle_site_webhook",
			_site_kwargs,
		),
	},
	BIN_TYPE_ID: {
		...
		"object.propertyChange": (
			f"{_HANDLER_PREFIX}.deployment_site_handler.handle_bin_webhook",
			_bin_kwargs,
		),
	},
}
...
for _machine_type_id in MACHINE_TYPE_TO_CHILD_TABLE:
	_OBJECT_TYPE_HANDLERS[_machine_type_id] = {
		"object.creation": (
			f"{_HANDLER_PREFIX}.deployment_site_handler.handle_machine_webhook",
			_machine_kwargs,
		),
		"object.propertyChange": (
			f"{_HANDLER_PREFIX}.deployment_site_handler.handle_machine_webhook",
...
for _engagement_type_id in ENGAGEMENT_TYPE_BY_OBJECT_TYPE_ID:
	_OBJECT_TYPE_HANDLERS[_engagement_type_id] = {
		"object.creation": (
			f"{_HANDLER_PREFIX}.activity_handler.handle_engagement_webhook",
			_engagement_kwargs,
		),
		"object.propertyChange": (
			f"{_HANDLER_PREFIX}.activity_handler.handle_engagement_webhook",
